...
struct FKawaiiPhysicsReference // : public FAnimNodeReference
{
	...
	void CallAnimNodeFunction(const FString& FunctionName, TFunction<void(const AnimNodeType&)> Function);
...
template<typename AnimNodeType>
inline void FKawaiiPhysicsReference::CallAnimNodeFunction(const FString& FunctionName, TFunction<void(const AnimNodeType&)> Function)
{
