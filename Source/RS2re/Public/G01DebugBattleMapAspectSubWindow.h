...
#include "G01DebugBattleMapAspectSubWindow.generated.h"

class AManagerBase;

UCLASS(Blueprintable)
class RS2RE_API UG01DebugBattleMapAspectSubWindow : public UG01DebugMenuSubWindow {
    GENERATED_BODY()
public:
    UG01DebugBattleMapAspectSubWindow();
