...
#include "G01GimmickAlenepShrineSwitchBase.generated.h"

UCLASS(Blueprintable)
class RS2RE_API AG01GimmickAlenepShrineSwitchBase : public AG01GimmickObjectBase, public IG01GimmickAlenepShrineObserverInf {
    GENERATED_BODY()
public:
protected:
...
public:
    AG01GimmickAlenepShrineSwitchBase(const FObjectInitializer& ObjectInitializer);
