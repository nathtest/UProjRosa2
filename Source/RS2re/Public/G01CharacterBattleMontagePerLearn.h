...
#include "G01CharacterBattleMontagePerLearn.generated.h"

class UAnimMontage;

USTRUCT(BlueprintType)
struct RS2RE_API FG01CharacterBattleMontagePerLearn : public FG01CharacterBattleMontageBase {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TSoftObjectPtr<UAnimMontage> AbilityMontageSoftObjectPtr;
    
    FG01CharacterBattleMontagePerLearn();
};
