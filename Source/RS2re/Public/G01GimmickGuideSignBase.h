...
#include "G01GimmickGuideSignBase.generated.h"

UCLASS(Blueprintable)
class RS2RE_API AG01GimmickGuideSignBase : public AG01GimmickObjectBase {
    GENERATED_BODY()
public:
protected:
...
public:
    AG01GimmickGuideSignBase(const FObjectInitializer& ObjectInitializer);
