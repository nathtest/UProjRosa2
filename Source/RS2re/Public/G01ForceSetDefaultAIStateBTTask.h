...
#include "G01ForceSetDefaultAIStateBTTask.generated.h"

UCLASS(Blueprintable)
class RS2RE_API UG01ForceSetDefaultAIStateBTTask : public UAppBTTask {
    GENERATED_BODY()
public:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    EAIState DefaultAIState;
    
    UG01ForceSetDefaultAIStateBTTask();
