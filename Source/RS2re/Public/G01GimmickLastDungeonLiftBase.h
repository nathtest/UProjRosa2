...
#include "G01GimmickLastDungeonLiftBase.generated.h"

UCLASS(Blueprintable)
class RS2RE_API AG01GimmickLastDungeonLiftBase : public AG01GimmickObjectBase {
    GENERATED_BODY()
public:
protected:
...
public:
    AG01GimmickLastDungeonLiftBase(const FObjectInitializer& ObjectInitializer);
