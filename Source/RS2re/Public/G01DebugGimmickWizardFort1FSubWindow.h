...
#include "G01DebugGimmickWizardFort1FSubWindow.generated.h"

class AManagerBase;

UCLASS(Blueprintable)
class RS2RE_API UG01DebugGimmickWizardFort1FSubWindow : public UG01DebugMenuSubWindow {
    GENERATED_BODY()
public:
    UG01DebugGimmickWizardFort1FSubWindow();
