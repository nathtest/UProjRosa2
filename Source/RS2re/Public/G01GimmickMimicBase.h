...
#include "G01GimmickMimicBase.generated.h"

class UFlagSystemManagerAccessCompo;

UCLASS(Blueprintable)
class RS2RE_API AG01GimmickMimicBase : public AG01GimmickObjectBase {
    GENERATED_BODY()
public:
protected:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FReceiveInteractEventInfo MMimicEvent;
...
public:
    AG01GimmickMimicBase(const FObjectInitializer& ObjectInitializer);
