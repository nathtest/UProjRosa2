...
#include "G01GimmickLogicMeterBase.generated.h"

UCLASS(Blueprintable)
class RS2RE_API AG01GimmickLogicMeterBase : public AG01GimmickObjectBase {
    GENERATED_BODY()
public:
protected:
...
public:
    AG01GimmickLogicMeterBase(const FObjectInitializer& ObjectInitializer);
