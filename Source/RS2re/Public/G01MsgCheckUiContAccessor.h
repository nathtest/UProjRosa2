...
#include "G01MsgCheckUiContAccessor.generated.h"

UCLASS(Blueprintable, ClassGroup=Custom, meta=(BlueprintSpawnableComponent))
class RS2RE_API UG01MsgCheckUiContAccessor : public UG01MsgUiControllerAccessorBase {
    GENERATED_BODY()
public:
    UG01MsgCheckUiContAccessor(const FObjectInitializer& ObjectInitializer);
