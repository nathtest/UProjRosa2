...
#include "G01DebugFieldPlayerGimmickSubWindow.generated.h"

class AManagerBase;

UCLASS(Blueprintable)
class RS2RE_API UG01DebugFieldPlayerGimmickSubWindow : public UG01DebugMenuSubWindow {
    GENERATED_BODY()
public:
    UG01DebugFieldPlayerGimmickSubWindow();
