...
#include "G01GimmickDreadQueenTransferDeviceBase.generated.h"

UCLASS(Blueprintable)
class RS2RE_API AG01GimmickDreadQueenTransferDeviceBase : public AG01GimmickObjectBase {
    GENERATED_BODY()
public:
protected:
...
public:
    AG01GimmickDreadQueenTransferDeviceBase(const FObjectInitializer& ObjectInitializer);
