...
#include "G01DebugFieldForceLevelSubWindow.generated.h"

class AManagerBase;

UCLASS(Blueprintable)
class RS2RE_API UG01DebugFieldForceLevelSubWindow : public UG01DebugMenuSubWindow {
    GENERATED_BODY()
public:
    UG01DebugFieldForceLevelSubWindow();
