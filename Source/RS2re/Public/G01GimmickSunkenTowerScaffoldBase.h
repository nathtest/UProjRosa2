...
#include "G01GimmickSunkenTowerScaffoldBase.generated.h"

UCLASS(Blueprintable)
class RS2RE_API AG01GimmickSunkenTowerScaffoldBase : public AG01GimmickObjectBase {
    GENERATED_BODY()
public:
protected:
...
public:
    AG01GimmickSunkenTowerScaffoldBase(const FObjectInitializer& ObjectInitializer);
